...
typedef struct {
    ...
    Unigine::SelectorNodes * unigine_object_ptr;
} unigine_SelectorNodes;
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = Unigine::SelectorNodes::createObjectsSelector(nodes);
            };
            // args
...
static PyObject * unigine_SelectorNodes_type(unigine_SelectorNodes* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->type();
            };
            // args
            // return
            int retOriginal;
...
static PyObject * unigine_SelectorNodes_equal(unigine_SelectorNodes* self, PyObject *args) {
    ...
    PyObject *ret = NULL;
    // parse args:
    PyObject *pArg1; // const UnigineEditor::Selector * selector;
    PyArg_ParseTuple(args, "O", &pArg1);
...
TODO for const UnigineEditor::Selector *
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->equal(selector);
            };
            // args
...
static PyObject * unigine_SelectorNodes_get_nodes(unigine_SelectorNodes* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getNodes();
            };
            // args
            // return
...
static PyObject * unigine_SelectorNodes_size(unigine_SelectorNodes* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->size();
            };
            // args
            // return
            int retOriginal;
...
static PyObject * unigine_SelectorNodes_empty(unigine_SelectorNodes* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->empty();
            };
            // args
            // return
            bool retOriginal;
...
TODO for const &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                self->unigine_object_ptr->extend(node);
            };
            // args
            const & node;
    };
...
TODO for const Unigine::Vector<Unigine::Ptr<Unigine::Node>> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                self->unigine_object_ptr->extend(nodes);
            };
            // args
            const Unigine::Vector<Unigine::Ptr<Unigine::Node>> & nodes;
    };
...
TODO for *
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                self->unigine_object_ptr->extend(node, subs);
            };
            // args
            const & node;
            * subs;
...
TODO for const &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                self->unigine_object_ptr->exclude(node);
            };
            // args
            const & node;
    };
...
TODO for const Unigine::Vector<Unigine::Ptr<Unigine::Node>> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                self->unigine_object_ptr->exclude(nodes);
            };
            // args
            const Unigine::Vector<Unigine::Ptr<Unigine::Node>> & nodes;
    };
...
static PyObject * unigine_SelectorNodes_exclude(unigine_SelectorNodes* self, PyObject *args) {
    ...
    PyObject *ret = NULL;
    // parse args:
    PyObject *pArg1; // SubObjectType stype;
    PyArg_ParseTuple(args, "O", &pArg1);
...
TODO for SubObjectType
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                self->unigine_object_ptr->exclude(stype);
            };
            // args
            SubObjectType stype;
    };
...
TODO for const &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->contains(node);
            };
            // args
            const & node;
            // return
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getSubItemList(node_id);
            };
            // args
            int node_id;
            // return
...
TODO for const &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getSubItemList(node);
            };
            // args
            const & node;
            // return
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getIndexList(node_id);
            };
            // args
            int node_id;
            // return
...
TODO for const &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getIndexList(node);
            };
            // args
            const & node;
            // return
...
TODO for SubObjectType
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getIntersectedIndexes(stype);
            };
            // args
            SubObjectType stype;
            // return
...
static PyObject * unigine_SelectorNodes_reset_cache(unigine_SelectorNodes* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                self->unigine_object_ptr->resetCache();
            };
            // args
    };
    auto *pRunner = new LocalRunner();
...
TODO for 
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                self->unigine_object_ptr->setUserData(name, value);
            };
            // args
            const char * name;
             value;
...
static PyObject * unigine_SelectorNodes_get_user_data(unigine_SelectorNodes* self, PyObject *args) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getUserData(name);
            };
            // args
            const char * name;
            // return
...
PyObject * SelectorNodes::NewObject(Unigine::SelectorNodes * unigine_object_ptr) {
...
Unigine::SelectorNodes * SelectorNodes::Convert(PyObject *pObject) {
