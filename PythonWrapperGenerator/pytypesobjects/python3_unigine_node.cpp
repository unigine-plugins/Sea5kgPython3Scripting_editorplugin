    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->toWorld(p);
            };
            // args
...
static PyObject * unigine_Node_get_id(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getID();
            };
            // args
            // return
            int retOriginal;
...
static PyObject * unigine_Node_get_type(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getType();
            };
            // args
            // return
            Unigine::Node::TYPE retOriginal;
...
static PyObject * unigine_Node_get_type_name(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getTypeName();
            };
            // args
            // return
            const char * retOriginal;
...
static PyObject * unigine_Node_is_world(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isWorld();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_geodetic(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isGeodetic();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_light(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isLight();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_decal(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isDecal();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_landscape_layer(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isLandscapeLayer();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_object(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isObject();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_player(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isPlayer();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_physical(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isPhysical();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_navigation(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isNavigation();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_obstacle(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isObstacle();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_sound(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isSound();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_field(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isField();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_extern(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isExtern();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_enabled_self(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isEnabledSelf();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_get_lifetime_self(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getLifetimeSelf();
            };
            // args
            // return
...
static PyObject * unigine_Node_is_enabled(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isEnabled();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_handled(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isHandled();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_immovable(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isImmovable();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_trigger_interaction_enabled(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isTriggerInteractionEnabled();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_grass_interaction_enabled(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isGrassInteractionEnabled();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_clutter_interaction_enabled(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isClutterInteractionEnabled();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_has_query_force(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->hasQueryForce();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_show_in_editor_enabled(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isShowInEditorEnabled();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_save_to_world_enabled(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isSaveToWorldEnabled();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_get_lifetime(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getLifetime();
            };
            // args
            // return
            Unigine::Node::LIFETIME retOriginal;
...
static PyObject * unigine_Node_is_show_in_editor_enabled_self(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isShowInEditorEnabledSelf();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_is_save_to_world_enabled_self(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isSaveToWorldEnabledSelf();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_get_name(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getName();
            };
            // args
            // return
            const char * retOriginal;
...
static PyObject * unigine_Node_get_data(unigine_Node* self, PyObject *args) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getData(name);
            };
            // args
            const char * name;
            // return
...
static PyObject * unigine_Node_get_ptr(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getPtr();
            };
            // args
            // return
            void * retOriginal;
...
static PyObject * unigine_Node_get_num_ancestors(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getNumAncestors();
            };
            // args
            // return
            int retOriginal;
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getAncestor(num);
            };
            // args
            int num;
            // return
...
static PyObject * unigine_Node_find_ancestor(unigine_Node* self, PyObject *args) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->findAncestor(name);
            };
            // args
            const char * name;
            // return
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->findAncestor(type);
            };
            // args
            int type;
            // return
...
static PyObject * unigine_Node_get_root_node(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getRootNode();
            };
            // args
            // return
            Unigine::Ptr<Unigine::Node> retOriginal;
...
TODO for const Unigine::Ptr<Unigine::Node> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isChild(n);
            };
            // args
            const Unigine::Ptr<Unigine::Node> & n;
            // return
...
static PyObject * unigine_Node_find_child(unigine_Node* self, PyObject *args) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->findChild(name);
            };
            // args
            const char * name;
            // return
...
TODO for const Unigine::Ptr<Unigine::Node> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getChildIndex(n);
            };
            // args
            const Unigine::Ptr<Unigine::Node> & n;
            // return
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->findNode(name, recursive);
            };
            // args
            const char * name;
            int recursive;
...
static PyObject * unigine_Node_get_possessor(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getPossessor();
            };
            // args
            // return
            Unigine::Ptr<Unigine::Node> retOriginal;
...
static PyObject * unigine_Node_get_num_properties(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getNumProperties();
            };
            // args
            // return
            int retOriginal;
...
static PyObject * unigine_Node_add_property(unigine_Node* self, PyObject *args) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->addProperty(name);
            };
            // args
            const char * name;
            // return
...
TODO for const Unigine::UGUID &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->addProperty(guid);
            };
            // args
...
TODO for const Unigine::Ptr<Unigine::Property> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->addProperty(property);
            };
            // args
...
static PyObject * unigine_Node_find_property(unigine_Node* self, PyObject *args) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->findProperty(name);
            };
            // args
            const char * name;
            // return
...
TODO for const Unigine::UGUID &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->findProperty(guid);
            };
            // args
            const Unigine::UGUID & guid;
            // return
...
TODO for const Unigine::Ptr<Unigine::Property> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->findProperty(property);
            };
            // args
            const Unigine::Ptr<Unigine::Property> & property;
            // return
...
static PyObject * unigine_Node_set_property(unigine_Node* self, PyObject *args) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->setProperty(name);
            };
            // args
            const char * name;
            // return
...
TODO for const Unigine::UGUID &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->setProperty(guid);
            };
            // args
            const Unigine::UGUID & guid;
            // return
...
TODO for const Unigine::Ptr<Unigine::Property> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->setProperty(property);
            };
            // args
            const Unigine::Ptr<Unigine::Property> & property;
            // return
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->setProperty(num, name);
            };
            // args
            int num;
            const char * name;
...
TODO for const Unigine::UGUID &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->setProperty(num, guid);
            };
            // args
            int num;
            const Unigine::UGUID & guid;
...
TODO for const Unigine::Ptr<Unigine::Property> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->setProperty(num, property);
            };
            // args
            int num;
            const Unigine::Ptr<Unigine::Property> & property;
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->insertProperty(num, name);
            };
            // args
            int num;
            const char * name;
...
TODO for const Unigine::UGUID &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->insertProperty(num, guid);
            };
            // args
            int num;
            const Unigine::UGUID & guid;
...
TODO for const Unigine::Ptr<Unigine::Property> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->insertProperty(num, property);
            };
            // args
            int num;
            const Unigine::Ptr<Unigine::Property> & property;
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getProperty(num);
            };
            // args
            int num;
            // return
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getPropertyName(num);
            };
            // args
            int num;
            // return
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->isPropertyEnabled(num);
            };
            // args
            int num;
            // return
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getLostNodePropertyGUID(num);
            };
            // args
            int num;
            // return
...
static PyObject * unigine_Node_get_transform(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getTransform();
            };
            // args
            // return
             retOriginal;
...
static PyObject * unigine_Node_get_world_transform(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getWorldTransform();
            };
            // args
            // return
             retOriginal;
...
static PyObject * unigine_Node_get_old_world_transform(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getOldWorldTransform();
            };
            // args
            // return
             retOriginal;
...
static PyObject * unigine_Node_get_old_world_position(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getOldWorldPosition();
            };
            // args
            // return
             retOriginal;
...
static PyObject * unigine_Node_get_i_world_transform(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getIWorldTransform();
            };
            // args
            // return
             retOriginal;
...
static PyObject * unigine_Node_get_world_bound_box(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getWorldBoundBox();
            };
            // args
            // return
            Unigine::Math::BoundBox retOriginal;
...
static PyObject * unigine_Node_get_world_bound_sphere(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getWorldBoundSphere();
            };
            // args
            // return
            Unigine::Math::BoundSphere retOriginal;
...
static PyObject * unigine_Node_get_spatial_bound_box(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getSpatialBoundBox();
            };
            // args
            // return
            Unigine::Math::BoundBox retOriginal;
...
static PyObject * unigine_Node_get_spatial_bound_sphere(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getSpatialBoundSphere();
            };
            // args
            // return
            Unigine::Math::BoundSphere retOriginal;
...
TODO for const Unigine::Ptr<Unigine::Xml> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->loadWorld(xml);
            };
            // args
...
TODO for const Unigine::Ptr<Unigine::Xml> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->saveWorld(xml);
            };
            // args
            const Unigine::Ptr<Unigine::Xml> & xml;
            // return
...
TODO for const Unigine::Ptr<Unigine::Stream> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->saveState(stream);
            };
            // args
...
TODO for const Unigine::Ptr<Unigine::Stream> &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->restoreState(stream);
            };
            // args
            const Unigine::Ptr<Unigine::Stream> & stream;
            // return
...
static PyObject * unigine_Node_get_object_body(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getObjectBody();
            };
            // args
            // return
...
static PyObject * unigine_Node_get_object_body_rigid(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getObjectBodyRigid();
            };
            // args
            // return
...
static PyObject * unigine_Node_get_body_linear_velocity(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getBodyLinearVelocity();
            };
            // args
            // return
...
static PyObject * unigine_Node_get_body_angular_velocity(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getBodyAngularVelocity();
            };
            // args
            // return
            Unigine::Math::vec3 retOriginal;
...
TODO for const &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getBodyWorldVelocity(point);
            };
            // args
            const & point;
            // return
...
static PyObject * unigine_Node_get_num_world_triggers(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getNumWorldTriggers();
            };
            // args
            // return
            int retOriginal;
...
TODO for int
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getWorldTrigger(num);
            };
            // args
            int num;
            // return
...
static PyObject * unigine_Node_get_position(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getPosition();
            };
            // args
            // return
             retOriginal;
...
static PyObject * unigine_Node_get_rotation(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getRotation();
            };
            // args
            // return
...
TODO for AXIS
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getDirection(axis);
            };
            // args
            AXIS axis;
            // return
...
static PyObject * unigine_Node_get_world_position(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getWorldPosition();
            };
            // args
            // return
             retOriginal;
...
static PyObject * unigine_Node_get_world_rotation(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getWorldRotation();
            };
            // args
            // return
            Unigine::Math::quat retOriginal;
...
TODO for AXIS
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getWorldDirection(axis);
            };
            // args
            AXIS axis;
            // return
...
static PyObject * unigine_Node_get_world_scale(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getWorldScale();
            };
            // args
            // return
            Unigine::Math::vec3 retOriginal;
...
TODO for const &
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->toLocal(p);
            };
            // args
            const & p;
            // return
...
static PyObject * unigine_Node_get_variable(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getVariable();
            };
            // args
            // return
...
static PyObject * unigine_Node_has_variable(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->hasVariable();
            };
            // args
            // return
            bool retOriginal;
...
static PyObject * unigine_Node_get_variable(unigine_Node* self, PyObject *args) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getVariable(name);
            };
            // args
            const char * name;
            // return
...
static PyObject * unigine_Node_has_variable(unigine_Node* self, PyObject *args) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->hasVariable(name);
            };
            // args
            const char * name;
            // return
...
static PyObject * unigine_Node_get_geodetic_pivot(unigine_Node* self) {
    ...
    class LocalRunner : public Python3Runner {
        public:
            virtual void run() override {
                retOriginal = self->unigine_object_ptr->getGeodeticPivot();
            };
            // args
            // return
