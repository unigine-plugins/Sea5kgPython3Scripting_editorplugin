...
protected:
	virtual ~Varjo(){}
public:
	UNIGINE_INLINE static Varjo *get() { return Unigine::Engine::get()->getPlugin<Varjo>("UnigineVarjo"); }
	...
	virtual void setStreamEnvironmentCubemapGGXQuality(Render::GGX_MIPMAPS_QUALITY quality) = 0;
	virtual Render::GGX_MIPMAPS_QUALITY getStreamEnvironmentCubemapGGXQuality() const = 0;
	...
	enum CAMERA_EXPOSURE_TIME
	{
		...
		CAMERA_EXPOSURE_TIME__91_MS = CAMERA_EXPOSURE_TIME_BEGIN,
		...
		CAMERA_EXPOSURE_TIME_END = CAMERA_EXPOSURE_TIME__8000_MS,
	};
	virtual void setCameraExposureTime(Varjo::CAMERA_EXPOSURE_TIME value) = 0;
	virtual Vector<double> getCameraSupportedExposureTimes() const = 0;
	...
	enum CAMERA_WHITE_BALANCE
	{
		...
		CAMERA_WHITE_BALANCE__2000_K = CAMERA_WHITE_BALANCE_BEGIN,
		...
		CAMERA_WHITE_BALANCE_END = CAMERA_WHITE_BALANCE__12000_K,
	};
	virtual void setCameraWhiteBalance(Varjo::CAMERA_WHITE_BALANCE value) = 0;
	virtual Vector<int> getCameraSupportedWhiteBalances() const = 0;
	...
	{
		CAMERA_ISO_BEGIN,
		CAMERA_ISO__100 = CAMERA_ISO_BEGIN,
		CAMERA_ISO__200,
		CAMERA_ISO__400,
		CAMERA_ISO__800,
		CAMERA_ISO__1600,
		CAMERA_ISO__3200,
		CAMERA_ISO__6400,
		CAMERA_ISO_END = CAMERA_ISO__6400,
	};
	virtual void setCameraISO(Varjo::CAMERA_ISO value) = 0;
	virtual Vector<int> getCameraSupportedISO() const = 0;
	...
	enum CAMERA_FLICKER_COMPENSATION
	{
		...
		CAMERA_FLICKER_COMPENSATION__50_HZ = CAMERA_FLICKER_COMPENSATION_BEGIN,
		CAMERA_FLICKER_COMPENSATION__60_HZ,
		CAMERA_FLICKER_COMPENSATION_END = CAMERA_FLICKER_COMPENSATION__60_HZ,
	};
	virtual void setCameraFlickerCompensation(Varjo::CAMERA_FLICKER_COMPENSATION value) = 0;
	virtual Vector<int> getCameraSupportedFlickerCompensations() const = 0;
	virtual void setCameraFlickerCompensation(int compensation) = 0;
	virtual int getCameraFlickerCompensation() const = 0;
	virtual int getCameraMinSharpness() const = 0;
	virtual int getCameraMaxSharpness() const = 0;
